...
export const tourSteps: TourStep[] = [
  ...
  },
  {
    ...
    target: 'arena-size',
    title: 'Arenans mått',
    body: 'Ange arenans längd och bredd i meter. Allt på banan ritas skalenligt, så måtten här styr hur mycket plats du har.',
    placement: 'right',
  },
  {
    id: 'palette',
    ...
    body: 'Dra ett hinder från listan ut på arenan. Grupper som Två tunnor och Parallellslalom placerar flera delar samtidigt med rätt avstånd.',
    placement: 'right',
  },
  {
    id: 'canvas-place',
    target: 'canvas',
    title: 'Arenan',
    body: 'Släpp hindret här. Dra för att flytta, använd rotationshandtaget för att vrida och Delete för att ta bort. Fäst till rutnät håller placeringen jämn.',
    placement: 'left',
  },
  {
    id: 'canvas-route',
    target: 'canvas',
    title: 'Ridvägen',
    body: 'Håll muspekaren över ett hinder så visas dess in- och utgångspunkter. Dra från en punkt för att lägga till ett passage-moment — ridvägen ritas automatiskt mellan momenten.',
    placement: 'left',
  },
  {
    id: 'sequence',
    ...
    title: 'Sekvensen',
    body: 'Listan visar passager, inte hinder. Samma hinder kan alltså förekomma flera gånger, till exempel ett hopp som rids åt båda hållen. Dra för att ändra ordning och numrering.',
    placement: 'left',
    tab: 'sequence',
  },
  {
  ...
  },
  {
    ...
    body: 'Spara laddar ner banan som en fil, Öppna läser in en tidigare sparad bana. Skriv ut ger dig en banskiss per klass. Du kan när som helst starta om den här genomgången med Introduktion.',
    placement: 'bottom',
  },
];
```
