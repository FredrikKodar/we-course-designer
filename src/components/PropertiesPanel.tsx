...
export default function PropertiesPanel() {
  ...
  if (!obstacle || obstacle.kind !== 'obstacle') {
    return <div className="text-gray-400 text-[12px]">Välj ett hinder</div>;
  }
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-1">
        <span className="text-[10px] text-gray-700">Rotation</span>
        <span className="flex items-center gap-1">
          ...
          />
          <span className="text-[10px] text-gray-700">&deg;</span>
        </span>
      </div>
